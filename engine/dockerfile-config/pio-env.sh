...
POSTGRES_JDBC_DRIVER=$PIO_HOME/lib/postgresql-42.2.4.jar
...
PIO_STORAGE_SOURCES_PGSQL_URL=jdbc:postgresql://$POSTGRES_HOST/$POSTGRES_DB
PIO_STORAGE_SOURCES_PGSQL_USERNAME=$POSTGRES_USER
